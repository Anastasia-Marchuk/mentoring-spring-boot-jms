...
public class Sender {
    ...
    private static final String ORDER_TOPIC = "topic.confirmed";
    private static final String ORDER_TOPIC_REJECTED = "topic.rejected";
    ...
    public void makeOrder( ) {
        ...
        if(!isOk){
            sender.send(ORDER_TOPIC_REJECTED, order, false, jmsTemplate);
        } else{
            sender.send(ORDER_TOPIC, order, true, jmsTemplate);
        }
